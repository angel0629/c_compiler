...
source: "https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/execvp-wexecvp?view=msvc-170"
source_tag: "mslearn"
license: "CC BY 4.0"
...
The **`_execvp`** functions validate their parameters. These functions invoke the invalid parameter handler, as described in [Parameter validation](https://learn.microsoft.com/en-us/cpp/c-runtime-library/parameter-validation?view=msvc-170), when:
