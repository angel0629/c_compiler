...
source: "https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/casin-casinf-casinl?view=msvc-170"
source_tag: "mslearn"
license: "CC BY 4.0"
...
The arcsine of _`z`_, in radians. The result is unbounded along the imaginary axis, and in the interval \[-π/2, +π/2\] along the real axis.
