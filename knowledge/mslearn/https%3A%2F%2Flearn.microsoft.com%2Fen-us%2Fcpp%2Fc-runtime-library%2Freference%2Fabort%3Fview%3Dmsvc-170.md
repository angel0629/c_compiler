---
title: "abort"
source: "https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/abort?view=msvc-170"
source_tag: "mslearn"
license: "CC BY 4.0"
...
If the Windows error reporting handler isn't invoked, then **`abort`** calls [`_exit`](https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/exit-exit-exit?view=msvc-170) to terminate the process with exit code 3 and returns control to the parent process or the operating system. `_exit` doesn't flush stream buffers or do `atexit`/`_onexit` processing.
...
[Using `abort`](https://learn.microsoft.com/en-us/cpp/cpp/using-abort?view=msvc-170)  
[`abort` function](https://learn.microsoft.com/en-us/cpp/c-language/abort-function-c?view=msvc-170)  
...
[`_set_abort_behavior`](https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/set-abort-behavior?view=msvc-170)