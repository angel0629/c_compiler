...
![../../_images/example_null_pointer.png](https://clang.llvm.org/docs/_images/example_null_pointer.png)
...
[2.9.8. Intentional Nullability Violation](#id8)[¶](#intentional-nullability-violation "Link to this heading")
--------------------------------------------------------------------------------------------------------------
