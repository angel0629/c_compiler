...
source: "https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/spawnlpe-wspawnlpe?view=msvc-170"
source_tag: "mslearn"
license: "CC BY 4.0"
...
List of pointers to arguments. The _`arg0`_ argument is typically a pointer to _`cmdname`_. The arguments _`arg1`_ through _`argN`_ are pointers to the character strings that form the new argument list. Following _`argN`_, there must be a `NULL` pointer to mark the end of the argument list.
