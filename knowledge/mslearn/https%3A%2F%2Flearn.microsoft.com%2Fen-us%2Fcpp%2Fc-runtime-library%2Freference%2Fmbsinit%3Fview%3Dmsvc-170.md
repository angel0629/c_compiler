---
title: "mbsinit"
source: "https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/mbsinit?view=msvc-170"
source_tag: "mslearn"
license: "CC BY 4.0"
...
_`ps`_  
A pointer to an [`mbstate_t`](https://learn.microsoft.com/en-us/cpp/c-runtime-library/standard-types?view=msvc-170) variable.

## Return value

Nonzero if _`ps`_ is `NULL` or if not in the middle of a conversion.
